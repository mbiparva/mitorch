...
# TODO add https://github.com/Project-MONAI/MONAI/blob/master/monai/networks/nets/ahnet.py
...
# TODO add https://github.com/Project-MONAI/MONAI/blob/master/monai/networks/nets/senet.py
