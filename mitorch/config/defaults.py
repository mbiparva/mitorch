...
_C.MODEL.SETTINGS = tuple({
    ...
    'Unet3DCBAM': CfgNode({
        'CBAM': CfgNode({
            ...
            'CHANNEL_POOLING_MODULATION_TYPE': ('additive', 'multiplicative', 'mean', 'concatenation', 'bypass')[3],
            'ATTENTION_MODULATION_TYPE': ('additive', 'multiplicative', 'mean', 'concatenation', 'bypass')[1],
            'CHANNEL_TYPES_MODULATION_TYPE': ('additive', 'multiplicative', 'mean', 'concatenation', 'bypass')[0],
        ...
        'BAM': CfgNode({
            'BLOCKS': [3, 4],
            'REDUCTION_RATIO': 16,
            'CROSS_MODAL_MODULATION_TYPE': ('additive', 'multiplicative', 'mean', 'concatenation', 'bypass')[0],
            'REF_MODULATION_TYPE': ('additive', 'multiplicative', 'mean', 'concatenation', 'bypass')[1],
