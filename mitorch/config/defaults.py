...
_C.MODEL.SETTINGS = tuple({
    ...
    'Unet3DCBAM': CfgNode({
        ...
        'CBAM_CHANNEL_POOLING_TYPES': ['max', 'average', 'pa', 'lse'][:2],
        'CBAM_REF_MODULATION_TYPE': ('additive', 'multiplicative', 'mean', 'concatenation', 'bypass')[3],
        'BAM_CROSS_MODAL_MODULATION_TYPE': ('additive', 'multiplicative', 'mean', 'concatenation', 'bypass')[0],
        'BAM_REF_MODULATION_TYPE': ('additive', 'multiplicative', 'mean', 'concatenation', 'bypass')[1],
        'BAM_RESIDUAL': (False, True)[1],
        'BAM_NUM_CONV_BLOCKS': 2,
        'BAM_DILATION': 4,
        'BAM_CHANNEL_POOLING_TYPE': ('max', 'average', 'pa', 'lse')[1],
