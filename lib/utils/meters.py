...
# For popular datasets such as AVA, COCO, IMAGENET, where dataset has train, val, test splits, write
# an umbrella class with all in there, check slowfast ava class
...
class TrainMeter(object):
    ...
    def get_avg_for_tb(self):  # This functions prepares and returns for Tensorboard logging
        meters = {
            ...
            'acc': self.num_top1_mis / self.num_samples,
        }
...
class ValMeter(object):
    ...
    def get_epoch_loss(self):
        return self.loss_total / self.num_samples,
